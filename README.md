...
**Math-Magicians-App** is a website for all fans of mathematics. It is a Single Page App (SPA) that allows users:
...
- [Live Demo Link](https://mohamedhnoor.github.io/math-magicians-app/)
